              ...
              <div class="bg-[#0aa6c1] px-4 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                  ...
                  <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div class="mt-2">
                    <h1 class="text-2xl text-center text-black">{{ dataPersona.trabajo }}</h1>
                    <br>
                    <h2 class="text-base text-black">Residencia: {{ dataPersona.residencia }}</h2>
                    <h2 class="text-base text-black">Cita: {{ dataPersona.cita }}</h2>
                    <h2 class="text-base text-black">Cita Autor: {{ dataPersona.citaAutor }}</h2>
                    <br>
                    <h2 class="text-base text-black">Biografia: {{ dataPersona.bio }}</h2>
                    <br>
                    <h2 class="text-lg text-black">Personalidad 1: {{ dataPersona.personalidad01 }}% Personalidad 2: {{ dataPersona.personalidad02 }}%</h2>
                     <h2 class="text-lg text-black">Personalidad 3: {{ dataPersona.personalidad03 }}% Personalidad 4: {{ dataPersona.personalidad04 }}%</h2>
                    <br>
                    <h2 class="text-lg text-black text-center">Objetivos</h2>
                    <br>
                     <div v-for="objetivo in dataPersona.objetivos" :key="objetivo.id">
                    <div class="text-base text-black text-center">*{{ objetivo.objetivo }}</div>

                    </div>
                    <br>
                    <h1 class="text-lg text-black text-center">Frustraciones</h1>
                    <br>

                    <div v-for="frustracion in dataPersona.frustraciones" :key="frustracion.id">
                      <div class="text-base text-black text-center">*{{ frustracion.frustracion }}</div>

                    </div>
                    <br>
                    <h1 class="text-lg text-black text-center">Motivaciones</h1>
                    <br>


                    <div v-for="motivacion in dataPersona.motivaciones" :key="motivacion.id">
                      <div class="text-base text-black text-center">*{{motivacion.motivacion }}</div>
