...
<template>
    <div >
        ...
        Claro que se necesita en poder implementar en  el cual en qué consiste el sitio que  se necesita para valorar el apoyo gratuito en la creación y publicación de tu sitio.
        Averigua las condiciones de un sitio web gratuito para nosotros será un placer apoyarte</h3>
            </div>
            </Item>
            <Item>
            <div class="text-2xl text-center" style="margin: 100px 300px 50px 300px">
            <h2>¿Que proyectos realizamos?</h2>
            </div>
    ...
    <div class="flex" >
            ...
            <p class="text-gray-700 text-base">
                Es la solución adecuada para:
                <br>
                -*-Poder realizar el registro de usuario
                <br>
                -*-Mostrar  diversa información que  cambia con el tiempo
                <br>
                -*-Realizar cálculos  la  información  usuarios
            </p>
            </div>
